...
def main(args):
    ...
    if args.resume_ckpt_path:
        ...
        trainer = Trainer(
            ...
            callbacks=[
                ModelCheckpoint(
                    dirpath="/root/Test/CM/junhsss_consistency-models-main/examples/unconditional_image_generation/ckpt",
                    save_top_k=3,
                    monitor="loss",
                )
            ],
...
python train_unconditional.py --dataset-name="/root/Test/CM/junhsss_consistency-models-main/examples/unconditional_image_generation/cifar10" --resolution=32  --train-batch-size=32 --max-epochs=100 --use-ema --learning-rate=1e-4
